...
class FilterBoxCheckBox extends StatefulWidget {
  final bool value;
  ...
  @override
  FilterBoxCheckBoxState createState() => FilterBoxCheckBoxState();
}

class FilterBoxCheckBoxState extends State<FilterBoxCheckBox> {
  late bool _checked;
  ...
  @override
  void didUpdateWidget(FilterBoxCheckBox oldWidget) {
